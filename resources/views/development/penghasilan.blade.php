        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <aside class="w-full lg:w-64 sidebar-glass rounded-2xl p-6 h-fit lg:sticky lg:top-32 sidebar"
                    ...
                    <!-- Balance Card -->
                    <div
                        class="mt-8 p-4 bg-gradient-to-br from-green-600/20 to-blue-600/20 rounded-xl border border-green-500/30">
                        ...
                        <button onclick="showWithdrawModal()"
                            class="w-full bg-green-600 hover:bg-green-700 text-white py-2 px-3 rounded-lg text-xs font-medium transition-colors">
                            Tarik Sekarang
                        </button>
                    </div>
                    ...
                    <div class="dev-card rounded-xl p-6 mb-8">
                        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6">
                            ...
                            <div class="flex space-x-2">
                                <button class="btn-secondary px-3 py-1 rounded text-sm active"
                                ...
                                <button class="btn-secondary px-3 py-1 rounded text-sm"
                                    onclick="updateChart('daily')">Harian</button>
                            </div>
                        </div>
                        <div class="h-80">
            ...
            <div class="modal-content dev-card rounded-2xl p-8 max-w-md w-full">
                ...
                <form id="withdraw-form">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" id="withdraw-amount"
                                class="search-input w-full pl-12 pr-4 py-3 rounded-lg text-white" placeholder="0"
                                min="50000" max="38472500" step="1000">
                        </div>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea class="search-input w-full px-4 py-3 rounded-lg text-white h-24 resize-none"
        ...
        <div class="flex items-center justify-center min-h-screen p-4">
            <div class="modal-content dev-card rounded-2xl p-8 max-w-md w-full">
                <div class="text-center">
                    ...
                    <p class="text-gray-300 mb-6">Permintaan penarikan Anda telah berhasil diproses. Dana akan masuk ke
                        rekening Anda dalam 2-5 hari kerja.</p>
                    <div class="bg-gray-800/50 rounded-lg p-4 mb-6">
                        <div class="flex justify-between text-sm mb-1">
