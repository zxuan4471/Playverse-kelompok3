...
<body class="text-white min-h-screen">
    ...
    <div class="pt-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col lg:flex-row gap-8">
                <!-- Sidebar -->
                <aside class="w-full lg:w-64 sidebar-glass rounded-2xl p-6 h-fit lg:sticky lg:top-32 sidebar"
                    id="sidebar">
                    ...
                    <nav class="space-y-2">
                        <a href="{{ url('/developer-dashboard') }}"
                            class="sidebar-item flex items-center px-4 py-3 text-sm text-gray-300 hover:text-white rounded-lg transition-all">
                            <i class="fas fa-chart-line mr-3"></i>
                            Dashboard
                        </a>
                        <a href="{{ url('/game-saya') }}"
                            class="sidebar-item flex items-center px-4 py-3 text-sm text-gray-300 hover:text-white rounded-lg transition-all">
                            <i class="fas fa-gamepad mr-3"></i>
                            Game Saya
                        </a>
                        <a href="{{ url('/asset-saya') }}"
                            class="sidebar-item active flex items-center px-4 py-3 text-sm rounded-lg transition-all">
                ...
                <main class="flex-1">
                    ...
                    <div class="mb-8">
                        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6">
                            ...
                            <a href="{{ url('/publish-asset') }}"
                                class="btn-neon px-6 py-3 rounded-lg text-sm font-medium mt-4 sm:mt-0">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-4 gap-4 mb-6">
                            <div
                                class="bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-xl p-4 border border-blue-500/30">
                            ...
                            <div
                                class="bg-gradient-to-r from-green-600/20 to-blue-600/20 rounded-xl p-4 border border-green-500/30">
                                <div class="flex items-center justify-between">
                                    <div>
                            ...
                            <div
                                class="bg-gradient-to-r from-yellow-600/20 to-orange-600/20 rounded-xl p-4 border border-yellow-500/30">
                                <div class="flex items-center justify-between">
                                    <div>
                            ...
                            <div
                                class="bg-gradient-to-r from-purple-600/20 to-pink-600/20 rounded-xl p-4 border border-purple-500/30">
                                <div class="flex items-center justify-between">
                                    <div>
                        ...
                        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
                            ...
                            <div class="relative">
                                <input type="text" placeholder="Cari asset..."
                                    class="bg-gray-800/50 border border-gray-700/50 rounded-lg px-4 py-2 pr-10 text-sm w-full sm:w-64">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                        ...
                        <div class="asset-card rounded-xl overflow-hidden">
                            <div class="relative">
                                <img src="https://picsum.photos/seed/asset1/400/300.jpg" alt="Asset Preview"
                                    class="w-full h-48 object-cover">
                                <div class="absolute top-3 right-3 flex gap-2">
                                    <span class="asset-type-badge">Gambar</span>
                                    <span
                                        class="status-public bg-green-500/20 text-green-400 px-3 py-1 rounded-full text-xs flex items-center">
                            ...
                            <div class="p-5">
                                ...
                                <p class="text-gray-400 text-sm mb-4">Texture kayu berkualitas tinggi untuk game dengan
                                    tema medieval.</p>
                        ...
                        <div class="asset-card rounded-xl overflow-hidden">
                            <div class="relative">
                                <div
                                    class="w-full h-48 bg-gradient-to-br from-purple-600 to-blue-600 flex items-center justify-center">
                            ...
                            <div class="p-5">
                                ...
                                <p class="text-gray-400 text-sm mb-4">Koleksi efek suara pedang untuk game action dan
                                    RPG.</p>
                        ...
                        <div class="asset-card rounded-xl overflow-hidden">
                            <div class="relative">
                                <img src="https://picsum.photos/seed/asset3/400/300.jpg" alt="Asset Preview"
                                    class="w-full h-48 object-cover">
                                <div class="absolute top-3 right-3 flex gap-2">
                                    <span class="asset-type-badge">Model 3D</span>
                                    <span
                                        class="status-private bg-red-500/20 text-red-400 px-3 py-1 rounded-full text-xs flex items-center">
                            ...
                            <div class="p-5">
                                ...
                                <p class="text-gray-400 text-sm mb-4">Model karakter knight dengan armor detail dan
                                    animasi dasar.</p>
                        ...
                        <div class="asset-card rounded-xl overflow-hidden">
                            <div class="relative">
                                <div
                                    class="w-full h-48 bg-gradient-to-br from-green-600 to-teal-600 flex items-center justify-center">
                                    <i class="fas fa-film text-6xl text-white/30"></i>
                                </div>
                                <div class="absolute top-3 right-3 flex gap-2">
                                    <span class="asset-type-badge">Animasi</span>
                                    <span
                                        class="status-review bg-yellow-500/20 text-yellow-400 px-3 py-1 rounded-full text-xs flex items-center">
                            ...
                            <div class="p-5">
                                ...
                                <p class="text-gray-400 text-sm mb-4">Animasi portal sihir dengan efek partikel yang
                                    menakjubkan.</p>
                        ...
                        <div class="asset-card rounded-xl overflow-hidden">
                            <div class="relative">
                                <img src="https://picsum.photos/seed/asset5/400/300.jpg" alt="Asset Preview"
                                    class="w-full h-48 object-cover">
                                <div class="absolute top-3 right-3 flex gap-2">
                                    <span class="asset-type-badge">Gambar</span>
                                    <span
                            ...
                            <div class="p-5">
                                ...
                                <p class="text-gray-400 text-sm mb-4">Skybox untuk scene cyberpunk dengan kota
                                    futuristik.</p>
                        ...
                        <div class="asset-card rounded-xl overflow-hidden">
                            <div class="relative">
                                <div
                                    class="w-full h-48 bg-gradient-to-br from-orange-600 to-red-600 flex items-center justify-center">
                            ...
                            <div class="p-5">
                                ...
                                <p class="text-gray-400 text-sm mb-4">Musik latar epik untuk scene boss battle atau
                                    cutscene.</p>
                    ...
                    <div class="flex justify-center mt-8">
                        <nav class="flex space-x-2">
                            <button
                                class="px-3 py-2 bg-gray-800/50 border border-gray-700/50 rounded-lg text-sm hover:bg-gray-700/50">
                                <i class="fas fa-chevron-left"></i>
                            </button>
                            <button class="px-4 py-2 bg-blue-600 border border-blue-500 rounded-lg text-sm">1</button>
                            <button
                                class="px-4 py-2 bg-gray-800/50 border border-gray-700/50 rounded-lg text-sm hover:bg-gray-700/50">2</button>
                            <button
                                class="px-4 py-2 bg-gray-800/50 border border-gray-700/50 rounded-lg text-sm hover:bg-gray-700/50">3</button>
                            <button
                                class="px-4 py-2 bg-gray-800/50 border border-gray-700/50 rounded-lg text-sm hover:bg-gray-700/50">
    ...
    <a href="{{ url('/publish-asset') }}" class="add-asset-fab">
