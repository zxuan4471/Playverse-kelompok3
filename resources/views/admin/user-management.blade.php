        ...
        <div class="p-6">
            ...
            <div class="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p class="text-gray-400 mt-1">Manage platform users, roles, permissions, and game publishing access</p>
                </div>
                <div class="flex items-center space-x-3">
            ...
            <div class="grid grid-cols-1 md:grid-cols-5 gap-6 mb-8">
                ...
                <div class="admin-card rounded-xl p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-gray-400 text-sm">Game Publishers</p>
            ...
            <div class="admin-card rounded-xl p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                    ...
                    <div>
                        <label class="block text-gray-400 text-sm mb-2">Game Publishing</label>
                        <select class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-white text-sm">
                            <option>All Users</option>
                            <option>Can Publish</option>
                            <option>Cannot Publish</option>
                ...
                <div class="filter-pills mb-4">
                    ...
                    <span class="filter-pill">Game Publishers</span>
                    <span class="filter-pill">Active Developers</span>
                    <span class="filter-pill">Revenue Generators</span>
            ...
            <div class="admin-card rounded-xl p-6">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <div class="flex items-center space-x-3">
                        <span class="text-gray-400 text-sm">Showing 1-10 of 28,641</span>
                    ...
                    <table class="table-dark w-full rounded-lg overflow-hidden">
                        <thead>
                            <tr>
                                ...
                                <th class="px-6 py-4 text-left cursor-pointer hover:bg-gray-800">
                                    Games Published <i class="fas fa-sort ml-1 text-gray-500"></i>
                                </th>
                                <th class="px-6 py-4 text-left cursor-pointer hover:bg-gray-800">
            ...
            <div class="modal-content rounded-xl p-6 w-full max-w-2xl">
                ...
                <form class="space-y-4">
                    ...
                    <div class="flex justify-end space-x-3 pt-4">
                        <button type="button" onclick="closeAddUserModal()" class="btn-secondary px-4 py-2 rounded-lg">Cancel</button>
                        <button type="submit" class="btn-primary px-4 py-2 rounded-lg">Create User</button>
                    </div>
                </form>
            </div>
        </div>
